...
def load_graph(dataset):
    ...
    # --------------------------
    # build second-order similarity matrix using adjacency matrix
    adj2 = adj.dot(adj)
    adj2 = adj2.toarray()
    ...
    # --------------------------
    # combine adjacency matrix and second-order similarity matrix
    eta = 0.3
    adj = (1 - eta) * adj + eta * adj.multiply(adj2)
    # --------------------------
